...
# chroma_net = GRU(128, return_sequences=True)(chroma_net)
# chroma_net = GRU(128, return_sequences=True)(chroma_net)
...
# merged_layers = layers.Maximum()([flattened_mfcc, flattened_logmel])  # [mfcc_gru, chroma_gru, logmel_gru, spectrogram_gru]

# full_connection = Dense(units=256, activation='relu')(merged_layers)
...
# plot_model(model, to_file='idontknowaugment.png', show_shapes=True, show_layer_names=True)

checkpoint_filepath = 'idontknowaugment.keras'
...
model.save('./idontknowaugment.keras')
