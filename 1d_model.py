...
# Conv2D Layer
conv1 = Conv1D(filters=64, kernel_size=80, strides=1, padding='valid')(audio_input)
...
# Add the GRU layer
gru = Attention(return_sequences=True)(layers.GRU(32, return_sequences=True)(reshape))
gru2 = Attention(return_sequences=True)(layers.GRU(32, return_sequences=True)(gru))
gru3 = Attention(return_sequences=True)(layers.LSTM(32, return_sequences=True)(gru2))
# gru4 = layers.LSTM(128, return_sequences=True)(gru3)
gru5 = Attention(return_sequences=False)(layers.LSTM(32, return_sequences=True)(gru3))
